...
<html>
    <head>
        ...
        <link rel="stylesheet" href="donu.css">
    </head>
    <body>
        <div id="cabecera">
            <br>
            <table>
                <tr>
                    <td class="botones"><a class="boton5" href="ServletRG">CREAR REPORTE</a></td>
                    <td class="botones"><a class="boton6" href="ServletDG">VER REPORTES</a></td>
